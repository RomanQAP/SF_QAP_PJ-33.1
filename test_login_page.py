...
# Тут нет валидных данных, взяты с потолка для демонстрации.
...
# В проверках assert, где требуется проверить "Неправильный логин или пароль" из-за наличия капчи тест будет ломаться.
